<main class="flex-1 p-6 ml-0 sm:ml-64 overflow-y-auto">
    <div class="flex justify-between items-center bg-gradient-to-tl from-blue-700 to-teal-400 text-white px-6 py-4 rounded-lg shadow mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div class="breadcrumb hidden sm:flex space-x-2 items-center">
                <p class="text-2xl text-white font-semibold">{{ $title }} | @if (Auth::user()->role == 'kepala-sekolah')
                        Kepala Sekolah
                    @elseif(Auth::user()->role == 'waka-kesiswaan')
                        Waka Kesiswaan
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative">
                ...
                <div id="dropdown-menu"
                    ...
                    <a href="/guru/profile/" class="block px-4 py-2 hover:bg-blue-50 text-center">Edit
                        Profil</a>
