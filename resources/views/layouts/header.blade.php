                ...
                <div class="relative">
                    ...
                    <div id="dropdown-menu"
                        ...
                        <div class="flex flex-col items-center py-4 px-4">
                            ...
                            @endif
                            <p class="mt-2 font-semibold break-all text-green-600">{{ Auth::user()->nama }}</p>
                        </div>

                        <hr class="border-gray-200" />

                        <a href="{{ Auth::user()->role == 'siswa' ? '/siswa/profile' : '/guru/profile' }}"
                            class="block px-4 py-2 hover:bg-blue-50 text-center">Edit
                            Profil</a>
